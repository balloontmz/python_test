...
# 邮件正文是MIMEText:
msg.attach(MIMEText('<html><body><h1>Hello</h1><p>send by <a href='
               '"http://www.python.org">python</a>...</p>'
                    '<p><a href="http://www.python.org"><img src="cid:image0"></a></p></body><html>',
               'html', 'utf-8')) # 文本文件, 图片带有外部链接
...
with open('1.png', 'rb') as f:
    ...
    #mime.add_header('X-Attachment-Id', '1') # 此行意义没了解
    print(mime)
    # 把附件内容添加进来：
